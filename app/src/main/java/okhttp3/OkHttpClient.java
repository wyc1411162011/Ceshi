...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
         ...
         * {@link
         *                  Protocol#HTTP_1_1}. It should not contain null or
         *                  {@link Protocol#HTTP_1_0}. If you use
         *                  {@link Protocol#H2C}, then it should be the only specified protocol in
         *                  the list.
         */
        public Builder protocols(List<Protocol> protocols) {
            ...
            if (protocols.contains(Protocol.H2C) && protocols.size() > 1) {
                ...
                throw new IllegalArgumentException("protocols containing h2c cannot use other " +
                        "protocols: "
                        + protocols);
